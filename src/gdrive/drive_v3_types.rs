    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        if let Some(ref v) = self.drive_id {
            write!(
                f,
                "&driveId={}",
                percent_encode(v.to_string().as_bytes(), NON_ALPHANUMERIC)
            )?;
        }
...
impl std::fmt::Display for ChangesListParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "&pageToken={}",
            percent_encode(self.page_token.to_string().as_bytes(), NON_ALPHANUMERIC)
        )?;
        if let Some(ref v) = self.drive_id {
            write!(
                f,
...
impl std::fmt::Display for DrivesCreateParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "&requestId={}",
            percent_encode(self.request_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        )?;
        Ok(())
    }
}
...
impl std::fmt::Display for FilesExportParams {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(
            f,
            "&mimeType={}",
            percent_encode(self.mime_type.to_string().as_bytes(), NON_ALPHANUMERIC)
        )?;
        Ok(())
    }
}
...
impl AboutService {
    ...
    pub async fn get(&self, params: &AboutGetParams) -> Result<About> {
        let rel_path = "about".to_string();
        let path = self.format_path(rel_path.as_str());

        let mut headers = vec![];
        let tok = if self.scopes.is_empty() {
            let scopes = &[DriveScopes::DriveReadonly.as_ref().to_string()];
            self.authenticator.token(scopes).await?
        } else {
        ...
        if let Some(ref api_params) = &params.drive_params {
            let _ = write!(url_params, "{}", api_params);
        }
...
impl ChangesService {
    ...
    pub async fn get_start_page_token(
        ...
        let rel_path = "changes/startPageToken".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn list(&self, params: &ChangesListParams) -> Result<ChangeList> {
        let rel_path = "changes".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn watch(&self, params: &ChangesWatchParams, req: &Channel) -> Result<Channel> {
        let rel_path = "changes/watch".to_string();
        let path = self.format_path(rel_path.as_str());
...
impl ChannelsService {
    ...
    pub async fn stop(&self, params: &ChannelsStopParams, req: &Channel) -> Result<()> {
        let rel_path = "channels/stop".to_string();
        let path = self.format_path(rel_path.as_str());
...
impl CommentsService {
    ...
    pub async fn create(&self, params: &CommentsCreateParams, req: &Comment) -> Result<Comment> {
        let rel_path = format!(
            ...
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn delete(&self, params: &CommentsDeleteParams) -> Result<()> {
        let rel_path = format!(
            ...
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC),
            commentId = percent_encode(params.comment_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        let path = self.format_path(rel_path.as_str());
...
impl DrivesService {
    ...
    pub async fn delete(&self, params: &DrivesDeleteParams) -> Result<()> {
        let rel_path = format!(
            "drives/{driveId}",
            driveId = percent_encode(params.drive_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        let path = self.format_path(rel_path.as_str());
...
impl FilesService {
    ...
    pub async fn create_upload(
        ...
        let rel_path = "/upload/drive/v3/files".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn create_resumable_upload(
        ...
        params: &FilesCreateParams,
        req: &File,
    ) -> Result<ResumableUpload<'_, File>> {
        let rel_path = "/resumable/upload/drive/v3/files".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn empty_trash(&self, params: &FilesEmptyTrashParams) -> Result<()> {
        let rel_path = "files/trash".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    ) -> Result<Download<'_, EmptyRequest, ()>> {
        let rel_path = format!(
            "files/{fileId}/export",
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
    ...
    pub async fn generate_ids(&self, params: &FilesGenerateIdsParams) -> Result<GeneratedIds> {
        let rel_path = "files/generateIds".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    ///
    /// This method potentially downloads data. See documentation of `Download`.
    pub async fn get(&self, params: &FilesGetParams) -> Result<Download<'_, EmptyRequest, File>> {
        let rel_path = format!(
            "files/{fileId}",
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
    ...
    pub async fn update(&self, params: &FilesUpdateParams, req: Option<&File>) -> Result<File> {
        let rel_path = format!(
            "files/{fileId}",
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        ...
        if req.is_some() {
            do_request(&self.client, &full_uri, &headers, "PATCH", req).await
        } else {
            do_request(
                &self.client,
                &full_uri,
    ...
    pub async fn delete(&self, params: &PermissionsDeleteParams) -> Result<()> {
        let rel_path = format!(
            ...
            permissionId = percent_encode(
                params.permission_id.to_string().as_bytes(),
                NON_ALPHANUMERIC
            )
        );
        let path = self.format_path(rel_path.as_str());
...
impl RepliesService {
    ...
    pub async fn delete(&self, params: &RepliesDeleteParams) -> Result<()> {
        let rel_path = format!(
            ...
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC),
            commentId = percent_encode(params.comment_id.to_string().as_bytes(), NON_ALPHANUMERIC),
            replyId = percent_encode(params.reply_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        let path = self.format_path(rel_path.as_str());
...
impl RevisionsService {
    ...
    pub async fn delete(&self, params: &RevisionsDeleteParams) -> Result<()> {
        let rel_path = format!(
            ...
            fileId = percent_encode(params.file_id.to_string().as_bytes(), NON_ALPHANUMERIC),
            revisionId =
                percent_encode(params.revision_id.to_string().as_bytes(), NON_ALPHANUMERIC)
        );
        let path = self.format_path(rel_path.as_str());
...
impl TeamdrivesService {
    ...
    pub async fn create(
        ...
        let rel_path = "teamdrives".to_string();
        let path = self.format_path(rel_path.as_str());
    ...
    pub async fn delete(&self, params: &TeamdrivesDeleteParams) -> Result<()> {
        let rel_path = format!(
            ...
            teamDriveId = percent_encode(
                params.team_drive_id.to_string().as_bytes(),
                NON_ALPHANUMERIC
            )
        );
        let path = self.format_path(rel_path.as_str());
